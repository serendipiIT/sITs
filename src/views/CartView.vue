        ...
        <section class="w-full">
          ...
          <div v-else class="flex flex-col height-full justify-center">
            <p class="text-xl text-center">
              ...
              with! Browse our amazing selection of products and treat yourself
              to something special. Happy shopping!
            </p>
          </div>
        </section>
        <section class="flex flex-row flex-wrap">
          <h2 class="w-full text-3xl">Tips på produkter</h2>
          <div>ett par produktbilder här</div>
          <div>ett par produktbilder här</div>
          <div>ett par produktbilder här</div>
        </section>
      </div>
